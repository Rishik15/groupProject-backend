...
def get_coach_profile(coach_id, user_timezone: str | None = None):
        ...
        formatted_certs.append(
            {
                ...
                "issued_date": (
                    str(cert["issued_date"]) if cert["issued_date"] else None
                ),
                "expires_date": (
                    str(cert["expires_date"]) if cert["expires_date"] else None
                ),
            }
        )
