...
class TestFormatDatetime:
    ...
    def test_returnsConvertedString(self):
        from app.services.sessions.sessionService import _format_datetime

        assert _format_datetime("2024-06-01 09:00:00") == "2024-06-01T05:00:00"
...
class TestScheduledTodayRoute:
    ...
    def test_success(self, auth_client):
        with patch(
            f"{ROUTE}.get_today_scheduled_sessions",
            return_value={
                "success": True,
                "events": [],
            },
...
class TestStartScheduledSessionRoute:
    ...
    def test_serviceFailure(self, auth_client):
        with patch(
            f"{ROUTE}.start_scheduled_session",
            return_value={
                "success": False,
                "reason": "not_found",
